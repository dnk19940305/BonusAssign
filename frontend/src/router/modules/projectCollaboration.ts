...
const projectCollaborationRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    component: () => import('@/views/project/ProjectCollaborationDetail.vue'),
    meta: {
      title: '项目协作详情',
      requiresAuth: true,
      permissions: ['project:view', '*'],
  ...
  },
  {
    ...
    name: 'ProjectPerformanceManual',
    component: () => import('@/views/project/ProjectPerformanceManual.vue'),
    meta: {
      title: '手动录入项目绩效',
      requiresAuth: true,
      permissions: ['project:view', '*'],
  ...
  {
    path: '/project/role-management',
    name: 'ProjectRoleManagement',
    component: () => import('@/views/project/ProjectRoleManagement.vue'),
    meta: {
      title: '项目角色管理',
      requiresAuth: true,
