      ...
      <div v-else class="batch-adjust">
        ...
        <el-card class="positions-card">
          ...
          <el-table :data="adjustedPositions" stripe>
            ...
            <el-table-column label="新基准值" width="130">
...
const handleSubmit = async () => {
  try {
    if (!props.isBatch) {
      ...
      loading.value = true
      const positionId = props.positions[0].id
      if (!positionId) {
