        ...
        <el-col :span="12">
          ...
          <el-card class="info-card team-card">
            ...
            <div class="team-stats">
              ...
              <div class="team-stat-item">
                <div class="stat-number">{{ teamMembers.length || 'N/A' }}</div>
              ...
              <div class="member-list">
                ...
                >
                  ...
                  <div class="member-info">
                    ...
                    <div class="member-role">{{ member.expectedRoleName || '成员' }}</div>
                  </div>
    ...
    >
      <div class="team-management">
        ...
        <el-table :data="teamMembers" style="width: 100%">
          ...
          <el-table-column prop="expectedRoleName" label="角色" />
...
const canEditProject = computed(() => {
  ...
  // 项目经理可以编辑项目：比较 employeeId 和 managerId
  return props.project?.managerId === getCurrentEmployeeId()
})
...
const canManageTeam = computed(() => {
  ...
  // 项目经理可以管理团队：比较 employeeId 和 managerId
  return props.project?.managerId === getCurrentEmployeeId()
})
...
const teamMembers = computed(() => {
  return props.project?.projectMembers || []
})
...
const getCurrentEmployeeId = () => {
  // 从用户 store 获取当前用户关联的员工 ID
  const userStore = useUserStore()
  // @ts-ignore
  return userStore.user?.employeeId
}
