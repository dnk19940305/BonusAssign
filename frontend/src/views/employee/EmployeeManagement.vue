  ...
  <div class="employee-management">
    <div class="page-header">
      ...
      <div class="header-actions">
        <el-button 
          v-if="userStore.hasAnyPermission(['employee:create', 'admin', 'hr', '*'])"
          type="primary" 
        ...
        <el-button 
          v-if="userStore.hasAnyPermission(['employee:export', 'admin', 'hr', '*'])"
          @click="handleExport"
        >
    ...
    <el-card class="search-card">
      <el-form :model="queryForm" inline>
        ...
        <el-form-item label="部门" >
          <el-select v-model="queryForm.departmentId" placeholder="请选择部门" clearable style="width: 150px;">
            <el-option
        ...
        <el-form-item label="岗位">
          <el-select v-model="queryForm.positionId" placeholder="请选择岗位" clearable  style="width: 150px;">
            <el-option
    ...
    <el-card 
      class="batch-actions" 
      v-if="selectedEmployees.length > 0 && userStore.hasAnyPermission(['employee:update', 'admin', 'hr', '*'])"
    >
      <el-alert
      ...
      <div class="batch-buttons">
        <el-button 
          v-if="userStore.hasAnyPermission(['employee:update', 'admin', 'hr', '*'])"
    ...
    <el-card class="table-card">
      ...
      >
        ...
        <el-table-column prop="entryDate" label="入职日期" width="120">
          <template #default="{ row }">
            {{ formatDate(row.entryDate, 'YYYY-MM-DD') }}
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" width="200" fixed="right">
          <template #default="{ row }">
            ...
            <el-dropdown 
              v-if="userStore.hasAnyPermission(['employee:update', 'employee:delete', 'admin', 'hr', '*'])"
              @command="(cmd: string) => handleMoreAction(cmd, row)"
            >
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  ...
                  <el-dropdown-item 
                    v-if="userStore.hasAnyPermission(['employee:update', 'admin', 'hr', '*']) && row.status === 1"
                    command="resign"
                  >
                    离职
                  </el-dropdown-item>
                  <el-dropdown-item 
                    v-if="userStore.hasAnyPermission(['employee:delete', 'admin', '*'])"
                    command="delete" 
                    divided
                  >
                    删除
