...
const getCityList = async () => {
  try {
    ...
    console.log('📊 城市列表响应:', data)
    cities.value = data.list || data
    console.log('✅ 城市列表获取成功，共', cities.value.length, '个城市')
  } catch (error) {
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const submitData = {
      ...
      emergencyContact: form.emergencyContact ? String(form.emergencyContact) : '',
      emergencyPhone: form.emergencyPhone ? String(form.emergencyPhone) : '',
