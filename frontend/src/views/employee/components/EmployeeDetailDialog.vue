      ...
      <el-card class="info-card">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <div class="detail-item">
              <label>入职日期：</label>
              <span>{{ formatDate(employee.entryDate, 'YYYY-MM-DD') }}</span>
            </div>
          </el-col>
        </el-row>
      </el-card>
      ...
      <el-card class="info-card" v-if="employee.status === 0">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <div class="detail-item">
              <label>离职日期：</label>
              <span>{{ formatDate(employee.resignDate, 'YYYY-MM-DD') || '-' }}</span>
            </div>
          </el-col>
          <el-col :span="12">
            <div class="detail-item">
...
import { formatDate, formatDateTime as utilFormatDateTime } from '@/utils/format'
...
const canEdit = computed(() => {
  return userStore.hasAnyPermission(['employee:update', 'admin', 'hr', '*'])
})
