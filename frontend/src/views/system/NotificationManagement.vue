<template>
  <div class="notification-management">
    <el-card class="management-card">
      <template #header>
        <div class="card-header">
          ...
          <div class="header-actions">
            <el-button 
              v-if="userStore.hasAnyPermission(['notification:create', 'admin', '*'])"
              type="primary" 
        ...
        >
          ...
          <el-table-column label="操作" width="150" fixed="right">
            <template #default="{ row }">
              ...
              <el-button
                v-if="userStore.hasAnyPermission(['notification:delete', 'admin', '*'])"
                size="small"
                type="danger"
      ...
      <div 
        class="batch-actions" 
        v-if="selectedNotifications.length > 0 && userStore.hasAnyPermission(['notification:update', 'notification:delete', 'admin', '*'])"
      >
        <el-button 
          v-if="userStore.hasAnyPermission(['notification:update', 'admin', '*'])"
          @click="batchMarkRead"
        >
          批量标记已读
        </el-button>
