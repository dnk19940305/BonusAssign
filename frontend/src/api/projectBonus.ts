...
// 新增：获取项目奖金分配详情
export function getProjectBonusDetails(projectId: string | number, period: string) {
  return request({
...
// 获取奖金池计算历史
export function getCalculationHistory(poolId: string) {
  return request({
    url: `/project-bonus/pools/${poolId}/history`,
    method: 'get'
  })
}