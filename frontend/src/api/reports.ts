...
// 下载报表
export function downloadReport(id: number, format: 'excel' | 'json' = 'excel') {
  return request({
...
export function createReportFromTemplate(templateId: number, params: any) {
  return request({
    url: `/reports/templates/${templateId}/generate`,
    method: 'post',
    data: params
  })
}
...
export function exportPersonalBonusReport(params: PersonalBonusQuery & {
  ...
  return request({
    url: '/reports/personal-bonus/export',
    method: 'post',
    data: params,
    responseType: 'blob'
  })
...
export function getBonusDistribution(params?: {
  ...
  return request({
    url: '/dashboard/bonus-distribution',
    method: 'get',
    params
  })
}
...
export function getEmployeeBonusHistory(employeeId: string, params?: {
  ...
  return request({
    url: `/reports/employees/${employeeId}/bonus-history`,
    method: 'get',
    params
  })
}
...
export function getEmployeePerformanceRadar(employeeId: string, period: string) {
  return request({
    url: `/reports/employees/${employeeId}/performance-radar`,
    method: 'get',
    params: { period }
  })
}