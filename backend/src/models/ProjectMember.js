...
ProjectMember.attributes = {
  ...
  applicationId: { type: 'STRING', allowNull: true }, // 团队申请ID
  roleId: { type: 'STRING', allowNull: true }, // 项目角色ID
  status: {
    type: 'STRING',
    allowNull: false,
    defaultValue: 'pending' // pending-待审批, active-参与中(兼容approved别名), rejected-已拒绝, removed-已移除
  },
