  ...
  async initializeDatabase() {
    try {
      ...
      const financeRole = {
        ...
        description: '财务相关权限',
        permissions: [
          'bonus:view', 'bonus:calculate', 'bonus:create',
          'report:view', 'report:export',
          'employee:view', 'department:view', 'project:view',
          'calculation:read', 'calculation:create', 'calculation:execute'  // 确保包含calculation:read
        ],
        status: 1,
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString()
