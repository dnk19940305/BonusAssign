...
const positionSchemas = {
  create: Joi.object({
    ...
    careerPath: Joi.object({
      nextLevel: Joi.string().allow('', null).optional(),
      estimatedTime: Joi.string().allow('', null).optional(),
      lateralMoves: Joi.array().items(Joi.string().allow('', null)).allow(null).optional(),
      specializations: Joi.array().items(Joi.string().allow('', null)).allow(null).optional(),
      growthAreas: Joi.array().items(Joi.string().allow('', null)).allow(null).optional()
    }).optional(),
    workEnvironment: Joi.object({
      travel: Joi.string().allow('', null).optional(),
      workType: Joi.string().allow('', null).optional()
    }).optional(),
    isComprehensive: Joi.boolean().optional(),
    isMarket: Joi.boolean().optional()
  }),
...
const positionEncyclopediaSchemas = {
  ...
  updateCareerPath: Joi.object({
    positionId: Joi.string().required(),
    careerPath: Joi.object({
      nextLevel: Joi.string().allow('', null).required(),
