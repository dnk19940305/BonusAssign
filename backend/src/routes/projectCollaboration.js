...
/**
 * @swagger
 * /api/project-collaboration/{projectId}/publish:
 *   post:
 *     summary: 管理层发布项目（将已存在的项目发布为协作项目）
 ...
 *         description: 项目不存在
 */
router.post('/:projectId/publish', checkPublishPermission, projectCollaborationController.publishCollaboration)

/**
 * @swagger
 * /api/project-collaboration/create-and-publish:
 *   post:
 *     summary: 创建并发布项目（一次性完成）
 *     tags: [ProjectCollaboration]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *         description: 无权限
 */
router.post('/create-and-publish', checkPublishPermission, projectCollaborationController.createAndPublishProject)
...
/**
 * @swagger
 * /api/project-collaboration/applications/{applicationId}/resubmit:
 *   post:
 *     summary: 重新提交申请（修改后）
 *     description: 申请被拒绝或需修改后，申请人可以重新提交
 *     tags: [ProjectCollaboration]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *         description: 申请不存在
 */
router.post('/applications/:applicationId/resubmit', checkTeamApplyPermission, projectCollaborationController.resubmitApplication)

/**
 * @swagger
 * /api/project-collaboration/available-projects:
 *   get:
 *     summary: 获取协作中心可申请项目列表（已过滤已申请项目）
 *     tags: [ProjectCollaboration]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *         description: 未认证
 */
router.get('/available-projects', projectCollaborationController.getAvailableProjects)
...
/**
 * @swagger
 * /api/project-collaboration/{projectId}/applications:
 *   get:
 *     summary: 获取项目的申请列表
 *     tags: [ProjectCollaboration]
 *     security:
 ...
 *         description: 项目不存在
 */
router.get('/:projectId/applications', checkProjectViewPermission, projectCollaborationController.getProjectApplications)
