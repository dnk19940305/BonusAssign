...
/**
 * @swagger
 * /api/business-lines/weights:
 *   put:
 *     tags:
 *       - 业务线管理
 *     summary: 批量更新业务线权重配置（系统默认值）
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 *       required: true
...
router.put('/weights',
  ...
  validate(businessLineSchemas.weights),
  logOperation('更新', '全局业务线权重'),
  businessLineController.updateBusinessLineWeights
)
