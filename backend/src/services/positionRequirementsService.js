...
class PositionRequirementsService {
  ...
  async getRequirementsByPositionCode(positionCode) {
    try {
      const requirements = await databaseService.findOne(this.requirementsCollection, { positionCode })
      return requirements
    } catch (error) {
  ...
  async getRequirementsByPositionName(positionName) {
    try {
      const requirements = await databaseService.findOne(this.requirementsCollection, { positionName })
      return requirements
    } catch (error) {
  ...
  async getAllRequirements() {
    try {
      const requirements = await databaseService.find(this.requirementsCollection, {})
      return requirements
    } catch (error) {
